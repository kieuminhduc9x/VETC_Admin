  ...
  <main-layout>
    <template v-slot:breadcrumb>
      <a-breadcrumb separator=">">
        ...
        <a-breadcrumb-item :class="'active'">Hậu kiểm </a-breadcrumb-item>
      </a-breadcrumb>
    </template>
    <div>
      <a-row :gutter="16">
              ...
              <a-row :gutter="16">
                ...
                <a-col :xs="24" :md="24" :lg="24">
                  <a-form-model-item
                    label="Loại lỗi"
                  >
                    <a-select v-model="form.loaitag">
                      <a-select-option v-for="item in listLoaitag" :key="item.id" :value="item.id">
                        {{ item.value }}
                      </a-select-option>
                    </a-select>
                  </a-form-model-item>
