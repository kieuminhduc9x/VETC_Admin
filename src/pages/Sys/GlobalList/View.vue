<template>
  <main-layout>
    ...
    <form-partner :partner-data="modelObject" :is-editable="false" v-if="modelObject&&modelObject.partnerId"/>
  </main-layout>
</template>
  ...
  beforeCreate () {
    this.form = this.$form.createForm(this, {
      ...
      onFieldsChange: (_, changedFields) => {
        if (changedFields.channelType !== undefined) {
          this.channelType = changedFields.channelType.value
        }
      }
    })
  },
