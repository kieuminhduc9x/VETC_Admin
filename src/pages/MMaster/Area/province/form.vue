      ...
      <a-form-model
        ...
        <a-row :gutter="16" type="flex">
          <a-col :xs="24" :sm="24" :md="12">
            <a-form-model-item
              label="Mã Tỉnh/TP" >
              {{ areaSelected.provinceCode }}
            </a-form-model-item>
          </a-col>
          <a-col :xs="24" :sm="24" :md="12">
            <a-form-model-item
              label="Tên Tỉnh/TP" >
              {{ areaSelected.provinceName }}
            </a-form-model-item>
          </a-col>
        </a-row>
...
import { UpdateProvince } from '@/api/common'
export default {
  name: 'HubForm',
  components: {
    ProvinceArea
  ...
  created () {
    ...
    this.hubForm = {
      ...
      provinceId: this.areaSelected.provinceId
    }
  },
  methods: {
    phoneValidator,
    ...
    doUpdate () {
      this.loading = true
      UpdateProvince(this.hubForm).then(res => {
