...
export default {
  name: 'CompletionRateByTimeChart',
  extends: Bar,
  data () {
    return {
      revenueType: 3,
  ...
  methods: {
    getDataByType (params) {
      ...
      switch (this.revenueType) {
        case 1:
          revenue = Dashboard.completionRateByMonth(params)
          break
        case 2:
          revenue = Dashboard.completionRateByQuarter(params)
          break
        default:
          revenue = Dashboard.completionRateByYear(params)
      }
      return revenue
    },
