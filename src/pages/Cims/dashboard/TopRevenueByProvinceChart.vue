...
export default {
  name: 'TopRevenueByProvinceChart',
  extends: Bar,
  data () {
    return {
      loading: false,
  ...
  methods: {
    getDataByType (params) {
      ...
      switch (this.revenueType) {
        case 1:
          revenue = Dashboard.greatestRevenueProvinceByMonth(params)
          break
        case 2:
          revenue = Dashboard.greatestRevenueProvinceByQuarter(params)
          break
        default:
          revenue = Dashboard.greatestRevenueProvinceByYear(params)
      }
      return revenue
    },
