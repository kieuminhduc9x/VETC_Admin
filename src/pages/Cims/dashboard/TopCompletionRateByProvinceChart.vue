...
export default {
  name: 'TopCompletionRateByProvinceChart',
  extends: Bar,
  data () {
    return {
      revenueType: 3,
  ...
  methods: {
    getDataByType (params) {
      ...
      switch (this.revenueType) {
        case 1:
          revenue = Dashboard.greatestCompletionRateProvinceByMonth(params)
          break
        case 2:
          revenue = Dashboard.greatestCompletionRateProvinceByQuarter(params)
          break
        default:
          revenue = Dashboard.greatestCompletionRateProvinceByYear(params)
      }
      return revenue
    },
