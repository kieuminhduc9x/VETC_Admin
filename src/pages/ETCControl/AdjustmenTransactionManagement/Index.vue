    ...
    <template v-slot:breadcrumb>
      <div style="display: flex; justify-content: space-between">
        <a-breadcrumb separator=">">
          ...
          <a-breadcrumb-item :class="'active'">Điều chỉnh giao dịch đã đối soát</a-breadcrumb-item>
        </a-breadcrumb>
...
import ModalCreate from '@/pages/ETCControl/AdjustmenTransactionManagement/ModalCreate'
  ...
  data () {
    ...
    return {
      ...
      data: [
        {
          rowIndex: '1',
          sogdnoibo: '12093754739',
          magiaodich: '43543543',
          ngaydoisoat: '22/02/2021',
          giavetruoc: '35,000',
          giavesau: '35,000',
          trangthaitruoc: 'Commit',
          trangthaisau: 'Rollback',
          ghichu: '',
          nguoi: 'Ngô Tiến Đăng'
        }
      ],
